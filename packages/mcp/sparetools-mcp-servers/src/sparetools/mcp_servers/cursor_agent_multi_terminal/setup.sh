...
echo "  cursor-multi"
echo ""
echo -e "${MAGENTA}Agent Specialties:${NC}"
...
echo "  ✓ Real cursor-agent instances in each terminal"
echo "  ✓ Command injection between terminals via files/xdotool"
echo "  ✓ MCP prompt templates for agent communication"
echo "  ✓ Color-coded terminals for different specialties"
echo "  ✓ Session management and coordination"
echo "  ✓ Real development workflow orchestration"
echo ""
