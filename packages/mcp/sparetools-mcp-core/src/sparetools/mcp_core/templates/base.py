...
from sparetools.mcp_core.templates.types import TemplateFile, TemplateMetadata
...
class BaseTemplate(ABC):
    ...
    Attributes:
        ...
        files: List of files in the template
    ...
    def substitute_variables(self, content: str) -> str:
        ...
        for name, value in self.variables.items():
            ...
            placeholder_with_spaces = f"{{{{ {name} }}}}"
            placeholder_without_spaces = f"{{{{{name}}}}}"
