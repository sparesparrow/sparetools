...
"""
Migration Info:
Original: ngapy/bench/ase_bench.py
Migrated: sparetools/test_environments/providers/aerospace/ase_environment.py
Date: 2024-XX-XX
Changes: Class name, imports, inheritance only
Logic Preserved: 100% - all ASE communication protocols intact
"""
...
from ngapy.bench.pmu_controller_ase import PMUController
from ngapy.bench.pmu_device_ase import PMUDevice
