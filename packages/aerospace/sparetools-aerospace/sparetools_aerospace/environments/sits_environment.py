...
"""
Migration Info:
Original: ngapy/bench/sits_bench.py
Migrated: sparetools/test_environments/providers/aerospace/sits_environment.py
Date: 2024-XX-XX
Changes: Class name, imports, inheritance only
Logic Preserved: 100% - all SITS communication protocols intact
"""
